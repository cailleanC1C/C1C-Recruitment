...
## AUDIT/legacy/clanmatch-welcomecrew/2025-10-10_code-export/MM/bot_clanmatch_prefix.py#L2044-L2081
```python
# ------------------- Health / reload -------------------
...
## AUDIT/legacy/clanmatch-welcomecrew/2025-10-10_code-export/MM/bot_clanmatch_prefix.py#L2161-L2297
```python
# ------------------- Events -------------------
@bot.event
...
## AUDIT/legacy/clanmatch-welcomecrew/2025-10-10_code-export/MM/bot_clanmatch_prefix.py#L2303-L2349
```python
...
## AUDIT/legacy/clanmatch-welcomecrew/2025-10-10_code-export/MM/bot_clanmatch_prefix.py#L2465-L2495
```python
...
## AUDIT/legacy/clanmatch-welcomecrew/2025-10-10_code-export/MM/bot_clanmatch_prefix.py#L2529-L2544
```python
# ------------------- Boot both -------------------
async def main():
    try:
...
## AUDIT/legacy/clanmatch-welcomecrew/2025-10-10_code-export/WC/bot_welcomecrew.py#L1098-L1105
```python
@bot.command(name="ping")
...
## AUDIT/legacy/clanmatch-welcomecrew/2025-10-10_code-export/WC/bot_welcomecrew.py#L1242-L1251
```python
...
## AUDIT/legacy/clanmatch-welcomecrew/2025-10-10_code-export/WC/bot_welcomecrew.py#L1272-L1276
```python
...
## AUDIT/legacy/clanmatch-welcomecrew/2025-10-10_code-export/WC/bot_welcomecrew.py#L1397-L1471
```python
# ---------- LIVE WATCHERS ----------
@bot.event
...
## AUDIT/legacy/clanmatch-welcomecrew/2025-10-10_code-export/WC/bot_welcomecrew.py#L1473-L1511
```python
async def _health_json(_req):
...
## AUDIT/legacy/clanmatch-welcomecrew/2025-10-10_code-export/WC/bot_welcomecrew.py#L1513-L1538
```python
async def start_webserver():
    app = web.Application()
    app["session"] = ClientSession()
...
## AUDIT/legacy/clanmatch-welcomecrew/2025-10-10_code-export/WC/bot_welcomecrew.py#L1804-L1812
```python
# ------------------------ start -----------------------
async def _boot():
