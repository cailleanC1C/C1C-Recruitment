...
ROLE_MAP_MARKER = "_(generated by !whoweare)_"
INDEX_HEADER_LINES = [
...
def build_category_message(category: RoleMapCategoryRender) -> str:
    ...
    for role in category.roles:
        ...
        if role.members:
            lines.append(f"• {', '.join(role.members)}")
        else:
...
async def cleanup_previous_role_map_messages(
    ...
    *,
    ...
    """Remove prior !whoweare posts (marked via ROLE_MAP_MARKER)."""
    ...
    try:
        async for message in history(limit=limit):
            ...
            if ROLE_MAP_MARKER not in content:
                continue
