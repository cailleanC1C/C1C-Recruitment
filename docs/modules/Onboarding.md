...
- **Summary data model** — supply the normalized answer payload (keyed by question `qid`, e.g., `w_power`, `w_hydra_diff`) that downstream UX layers format into embeds (layout requirements live in [`docs/_meta/DocStyle.md`](../_meta/DocStyle.md)).
